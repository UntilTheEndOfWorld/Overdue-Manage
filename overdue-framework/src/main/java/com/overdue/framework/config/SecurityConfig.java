...
import com.overdue.framework.security.handle.AuthenticationEntryPointImpl;
import com.overdue.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
     ...
     */
    @Autowired
    private MemberAuthenticationTokenFilter memberAuthenticationTokenFilter;
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        // 添加会员认证过滤器（在JWT过滤器之前）
        httpSecurity.addFilterBefore(memberAuthenticationTokenFilter, JwtAuthenticationTokenFilter.class);
        // 添加CORS filter
