...
import com.overdue.manager.oms.domain.query.OrderQuery;
...
import com.overdue.manager.oms.domain.vo.ManagerOrderDetailVO;
import com.overdue.manager.oms.domain.vo.ManagerOrderVO;
import com.overdue.manager.oms.domain.vo.OrderOperateHistoryVO;
...
public class OrderController extends BaseController {
    ...
    public ResponseEntity<ManagerOrderDetailVO> getInfo(@PathVariable("id") Long id) {
        return ResponseEntity.ok(service.selectManagerOrderDetailVOById(id));
    }
