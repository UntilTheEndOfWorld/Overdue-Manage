...
public class Order extends BaseAudit {
    ...
    @ApiModelProperty("商户订单号（微信支付out_trade_no）")
    ...
    @ApiModelProperty("配送方式：express-快递配送，pickup-到店取货，local-同城配送")
    @Excel(name = "配送方式")
    ...
    @ApiModelProperty("同城配送号码")
    @Excel(name = "同城配送号码")
    private String localDeliveryCode;
