package com.overdue.manager.ums.domain.entity;
...
public class Member extends BaseAudit {
    ...
    @ApiModelProperty("是否为经销商：0-普通用户，1-经销商")
    @Excel(name = "是否为经销商")
    private Integer isDealer;

    @ApiModelProperty("经销商等级：0-普通用户，1-初级经销商，2-中级经销商，3-高级经销商")
    @Excel(name = "经销商等级")
    private Integer dealerLevel;

    @ApiModelProperty("经销商状态：0-未申请，1-待审核，2-已通过，3-已拒绝")
    @Excel(name = "经销商状态")
    private Integer dealerStatus;

    @ApiModelProperty("经销商申请时间")
    @Excel(name = "经销商申请时间", width = 30, dateFormat = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime dealerApplyTime;

    @ApiModelProperty("经销商审核时间")
    @Excel(name = "经销商审核时间", width = 30, dateFormat = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime dealerAuditTime;
