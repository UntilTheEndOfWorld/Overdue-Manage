...
import com.overdue.manager.ums.mapper.FeedbackMapper;
import com.overdue.manager.ums.domain.entity.Feedback;
import com.overdue.manager.ums.domain.query.FeedbackQuery;
...
public class FeedbackService {
     ...
     * @return 反馈列表
     */
    public List<Feedback> selectListByMemberId() {
        QueryWrapper<Feedback> qw = new QueryWrapper<>();
        qw.eq("create_by", SecurityUtil.getLocalMember().getId());
