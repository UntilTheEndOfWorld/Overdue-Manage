...
public class PayNotifyController {
    ...
    public void weChatPayNotify(HttpServletRequest request) throws Exception {
        ...
        Config config = wechatPayService.getWechatPayConfig();
        ...
        message.setOutTradeNo(transaction.getOutTradeNo());
        ...
        message.setPayTime(
                formatter.parse(transaction.getSuccessTime().substring(0, transaction.getSuccessTime().indexOf("+"))));
