...
export const dynamicRoutes = [
  ...
  {
    path: '/pms/points-product',
    component: Layout,
    hidden: true,
    permissions: ['pms:points-product:list'],
    children: [
      {
        path: 'add',
        component: () => import('@/views/pms/pointsProduct/AddPointsProduct'),
  ...
  },
  {
    ...
    component: Layout,
    hidden: true,
    permissions: ['pms:merchant:list'],
    children: [
      {
        path: 'index',
        component: () => import('@/views/pms/merchant/index'),
        name: 'Merchant',
        meta: { title: '商户管理' }
      }
    ]
