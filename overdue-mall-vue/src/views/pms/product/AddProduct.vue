        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="价格类型" prop="priceType">
              <el-select v-model="form.priceType" placeholder="请选择价格类型" clearable>
                <el-option label="固定价格" :value="0"></el-option>
                <el-option label="每日调价" :value="1"></el-option>
                <el-option label="时价" :value="2"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否今日价">
              <el-switch v-model="form.isTodayPrice" :active-value="1" :inactive-value="0"></el-switch>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="重量范围">
              <el-col :span="11">
                <el-input v-model="form.weightRangeMin" placeholder="最小"></el-input>
              </el-col>
              <el-col :span="2" style="text-align: center">-</el-col>
              <el-col :span="11">
                <el-input v-model="form.weightRangeMax" placeholder="最大"></el-input>
              </el-col>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="成本价" prop="costPrice">
              <el-input v-model="form.costPrice" placeholder="请输入成本价（后台可见）"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="利润率(%)" prop="profitRate">
              <el-input v-model="form.profitRate" placeholder="请输入利润率"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="价格说明" prop="priceNote">
              <el-input v-model="form.priceNote" placeholder="如：价格随行就市"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="是否轮播">
              <DictRadio v-model="form.isBanner" size="small"
                        :radioData="dict.type.pms_is_banner"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="是否支持快递">
              <DictRadio v-model="form.supportExpress" size="small"
                        :radioData="dict.type.pms_support_express"/>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否原产地发货">
              <DictRadio v-model="form.originDelivery" size="small"
                        :radioData="dict.type.pms_origin_delivery"/>
            </el-form-item>
          </el-col>
        </el-row>
      </el-card>
        ...
        <el-form-item label="规格信息">
          ...
          <el-table :data="form.skuList" :max-height="400">
            ...
            <el-table-column label="成本价">
              <template v-slot="{ row }">
                <el-input v-model="row.costPrice" placeholder="成本价"></el-input>
              </template>
            </el-table-column>
            <el-table-column label="重量标签" width="120">
              <template v-slot="{ row }">
                <el-input v-model="row.weightLabel" placeholder="如：小号300g"></el-input>
              </template>
            </el-table-column>
            <el-table-column label="重量值(克)">
              <template v-slot="{ row }">
                <el-input v-model="row.weightValue" type="number" placeholder="克"></el-input>
              </template>
            </el-table-column>
...
export default {
  name: "AddProduct",
  dicts: ['pms_publish_status', 'pms_is_banner', 'pms_support_express', 'pms_origin_delivery', 'pms_product_unit'],
