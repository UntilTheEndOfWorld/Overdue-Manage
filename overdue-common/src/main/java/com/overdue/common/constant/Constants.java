package com.overdue.common.constant;
...
public class Constants {
    ...
    /**
     * 过期了吗小程序用户ID（LocalDataUtil中存取的key）
     */
    public static final String OVERDUE_USER_ID = "overdue_user_id";

    /**
     * 自动识别json对象白名单配置（仅允许解析的包名，范围越小越安全）
     */
    public static final String[] JSON_WHITELIST_STR = { "org.springframework", "com.ruoyi", "com.cyl", "com.overdue" };
